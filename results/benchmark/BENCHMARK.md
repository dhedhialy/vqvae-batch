...
|---|---|---|---|---|---|
| ours bt5 w=0.02 | 1.03/1.08 fail | n/a | 0.80/0.89 fail | 0.80/1.05 fail | 0.45/1.04 **PASS** |
| ours bt5 w=0.10 | 0.99/1.14 fail | n/a | 0.83/0.92 fail | 0.67/0.98 fail | 0.35/1.18 **PASS** |
| ours bt5 w=0.30 | 0.98/1.15 fail | n/a | 0.63/0.97 fail | 0.58/0.86 fail | 0.11/1.02 **PASS** |
| ours bt5 w=0.50 | 1.07/1.08 fail | n/a | 0.43/1.04 **PASS** | 0.54/0.81 fail | 0.00/0.97 **PASS** |
